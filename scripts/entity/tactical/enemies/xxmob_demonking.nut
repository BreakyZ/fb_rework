this.xxmob_demonking <- this.inherit("scripts/entity/tactical/human", {
	...
	function onInit()
	{
		...
		this.m.Skills.add(this.new("scripts/skills/actives/ai_demonkingbuff"));
		this.m.Skills.add(this.new("scripts/skills/actives/warcry"));
		local skilla = this.new("scripts/skills/actives/whip_skill");
		skilla.m.Overlay = "active_21";
		skilla.m.DirectDamageMult = 0.5;
		...
		this.getSprite("tattoo_body").setBrush("scar_01_bust_naked_body_00");
		...
		this.setSpriteOffset("permanent_injury_5", this.createVec(2, -12));

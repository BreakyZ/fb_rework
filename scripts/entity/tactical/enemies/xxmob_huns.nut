this.xxmob_huns <- this.inherit("scripts/entity/tactical/human", {
	...
	{
		this.actor.onUpdate();
		if (!this.m.Skills.hasSkill("effects.xxitem_horse_skill") && this.m.Skills.hasSkill("actives.ai_damaged_move"))
		{
			this.m.Skills.removeByID("actives.ai_damaged_move");
		}
	}
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		if (_killer == null || _killer.getFaction() == this.Const.Faction.Player || _killer.getFaction() == this.Const.Faction.PlayerAnimals)
		{
			...
			{
				loot = this.new("scripts/items/helmets/xxhat_hunshat");
				loot.drop(_tile);
			}

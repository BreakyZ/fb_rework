this.xxmob_knight <- this.inherit("scripts/entity/tactical/human", {
	...
	function onInit()
	{
		...
		b.Hitpoints += this.Math.rand(400, 600);
		b.MeleeSkill -= 10;
		b.Bravery += 900;
		b.Stamina += 200;
		b.DamageRegularMin += 10;
		...
		this.m.Skills.add(this.new("scripts/skills/actives/ai_knightbuff"));
	}
	...
	function assignRandomEquipment()
	{
		...
		itt.setUpgrade(uu);
		itt.m.Condition = this.Math.rand(400, 600);
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		if (_tile != null)
		{
			...
			local decal = _tile.spawnDetail("bust_xxcorpse_dead", this.Const.Tactical.DetailFlag.Corpse, flip, false);

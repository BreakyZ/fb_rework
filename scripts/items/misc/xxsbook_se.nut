this.xxsbook_se <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Selective Skill Book";
		this.m.Description = "Choose one special skill to learn. Previously learned special skills are lost. There is no penalty for learning this multiple times. (Some special mercenaries cannot use skill books)";
